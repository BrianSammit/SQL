...
-- (range specified is inclusive of boundary values). The example below shows countries with 
-- an area of 250,000-300,000 sq. km. Modify it to show the country and the area for 
